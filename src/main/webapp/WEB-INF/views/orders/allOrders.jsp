            ...
            <table class="table center">
                ...
                <c:forEach var="order" items="${orders}">
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-outline-dark" href="${pageContext.request.contextPath}/viewOrder?order_id=${order.id}">View</a>
                            <a class="btn btn-outline-dark" href="${pageContext.request.contextPath}/deleteOrder?order_id=${order.id}">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
